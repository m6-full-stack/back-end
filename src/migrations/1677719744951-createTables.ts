...
export class createTables1677719744951 implements MigrationInterface {
    name = 'createTables1677719744951'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "email" character varying(50) NOT NULL, "password" character varying NOT NULL, "phone" character varying NOT NULL, "cpf" character varying NOT NULL, "birthdate" date, "description" character varying, "is_seller" boolean DEFAULT false, "created_at" date NOT NULL, "updated_at" date NOT NULL, "addressId" uuid, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
