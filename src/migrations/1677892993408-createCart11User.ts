...
export class createCart11User1677892993408 implements MigrationInterface {
    name = 'createCart11User1677892993408'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "announcement" ADD CONSTRAINT "FK_9f010540ae18ae5d1db5dd0c47b" FOREIGN KEY ("advertiserId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
